...
const buildPairJudgeSystemPrompt = (language: Language): string => {
  if (language === 'en') {
...
const buildPairJudgeUserPrompt = (language: Language): string => {
  if (language === 'en') {
...
const buildSynthesisSystemPrompt = (language: Language): string => {
  if (language === 'en') {
...
const buildSynthesisUserPrompt = (language: Language): string => {
  if (language === 'en') {
